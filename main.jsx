...
const proofs = [
  { title: "$88,998+", subtitle: "Lifetime payouts", name: "William R.", tone: "gold", image: "/mnt/data/efe42d37-b150-4478-a81e-32af6e218ffe.png" },
  { title: "$3,000", subtitle: "Payout certificate", name: "Massimo D.", tone: "blue", image: "/mnt/data/320fb357-bb88-4ead-bae7-dece3fe508e3.png" },
  { title: "$1,293", subtitle: "Payout certificate", name: "Massimo D.", tone: "blue", image: "/mnt/data/729da40e-9783-44e6-83ef-1a8bc9ec1236.png" },
  { title: "$1,332", subtitle: "Payout certificate", name: "Massimo D.", tone: "blue", image: "/mnt/data/5d7bfb14-eab1-4e54-8f5c-3cb7affdcd12.png" },
  { title: "$1,304", subtitle: "Payout certificate", name: "Massimo D.", tone: "blue", image: "/mnt/data/0eb4dd7a-1f47-4405-bd0c-769c7ad566ee.png" },
  { title: "$41,372", subtitle: "Wise payment received", name: "TAKEPROFITTRADER LLC", tone: "green", image: "/mnt/data/901f040e-c04b-4df6-b5eb-4815df3d6ab6.png" },
  { title: "$20,000+", subtitle: "Prop firm payouts", name: "Multiple accounts", tone: "silver", image: "/mnt/data/c3b6209c-15e4-4b60-ad2b-31915bd57fb9.png" },
  { title: "$22,000+", subtitle: "Payout table", name: "Verified accounts", tone: "silver", image: "/mnt/data/c53e1833-c3b2-4b07-a04d-ec2dfec42db2.png" },
];
...
export default function TheMethodEliteWebsite() {
