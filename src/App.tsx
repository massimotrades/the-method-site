  ...
  return (
    <div className="vsl-card" aria-label="The Method VSL video placeholder">
      ...
      <div className="vsl-card__caption">
        ...
        <strong>A system for consistency</strong>
      </div>
    </div>
  );
}
        ...
        <div className="shell hero__grid">
          <div className="hero__copy reveal reveal--one">
            ...
            <p className="hero__lead">
              A clear, repeatable framework built to help serious traders develop
            ...
            <div className="hero__proof">
              <span>Real traders</span><i />
              <span>Real payouts</span><i />
          ...
          <div className="hero__media reveal reveal--two">
            ...
            <p className="video-note">
              {VSL_EMBED_URL ? "Watch the complete overview" : "Your VSL video will go here"}
            </p>
          </div>
        </div>
      ...
      <section className="problem section">
        <div className="shell split-grid">
          <div className="section-heading">
            <p className="eyebrow"><span /> Why traders stay stuck</p>
            <h2>You probably don&apos;t need another strategy.</h2>
          </div>
          <div className="problem__content">
            <p className="lead-copy">
              Most traders already know enough to take a winning trade. The problem
              is repeating good decisions when money and emotions are involved.
            </p>
            <ul className="check-list">
              <li><span>01</span> You change your model after every losing day.</li>
              <li><span>02</span> You overtrade, overleverage, or revenge trade.</li>
              <li><span>03</span> You pass evaluations but struggle to reach payouts.</li>
              <li><span>04</span> You know what to do, but cannot execute it consistently.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="results section" id="results">
        <div className="shell">
          <div className="results__header">
            <div className="section-heading">
              <p className="eyebrow"><span /> Documented experience</p>
              <h2>Proof matters. Promises don&apos;t.</h2>
            </div>
            <p>
              A selection of payout confirmations from our own trading. These are
              examples—not guarantees of what another trader will achieve.
            </p>
          </div>
          <div className="payout-grid">
            {payouts.map((payout, index) => (
              <figure className={`payout-card payout-card--${(index % 4) + 1}`} key={payout}>
                <img src={payout} alt={`Trading payout confirmation ${index + 1}`} loading="lazy" />
              </figure>
            ))}
          </div>
        </div>
