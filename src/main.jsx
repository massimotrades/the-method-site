...
>
    ...
    <div className="mt-14 grid items-center gap-10 md:grid-cols-[0.75fr_1.25fr]">
      ...
      <div>
        ...
        <p className="mt-5 text-lg leading-relaxed text-white/65">
          William is the trader behind the core Method models and execution framework.
        </p>
  ...
  <div className="mx-auto max-w-6xl">
    <div className="text-center">
      ...
      <h2 className="mt-4 text-5xl font-black tracking-[-.05em] md:text-6xl">
        Prop Firms We Use & Trust
      </h2>
